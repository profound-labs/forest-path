...
breath in the present moment, I practice quieting the mind, cutting off
...
you get is just a cause for suffering, so we practice not getting
...
practice a lot. We're far away from any distraction. The nearest Thai
...
When I think about this it makes me want to practice even harder. 
...
timelessness. There's no time to practice awakening except the present
moment. 
...
just dhammas. We practice to know things just as they are, impermanent
...
that they are not practising pure Dhamma. To say that you can practice
...
practice \emph{sīla, samādhi} and \emph{paññā} and tread the path to
...
with \emph{mettā}, I practice letting go. 
